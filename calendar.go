...
// SerializeTo. Unsupported types return an error.
...
func (cal *Calendar) componentParseOptions() []any {
	...
	if cal.unknownComponentPropertyHandler != nil {
		opts = append(opts, cal.unknownComponentPropertyHandler)
	}
	if cal.unknownComponentHandler != nil {
		opts = append(opts, cal.unknownComponentHandler)
	}
